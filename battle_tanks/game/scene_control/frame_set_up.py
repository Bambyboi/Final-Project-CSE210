...
from game.casting.bullet import Bullet  #changed to 'Bullet' from 'Ball'
from game.casting.body import Body # Same
from game.casting.brick import Brick # Same (Though we need a wall builder, which will likely need to be a class of its own in scripting maybe?)
from game.casting.image import Image # Same
from battle_tanks.game.casting.label import Label # Same, but for some reason had to put battle_tanks. at the front of it
from game.casting.point import Point # Same
from game.casting.racket import Racket # Changed to Tank, has new methods too
